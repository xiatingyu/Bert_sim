...
class NLIDataset(Dataset):
    ...
    def __init__(self,
        ...
        if isRandom == True:
            print('random data!!!')
            index = random.sample(data["ids"], length)
            data["ids"] = [data['ids'][i] for i in index]
            data["premises"] = [data['premises'][i] for i in index]
            data["hypotheses"] = [data['hypotheses'][i] for i in index]
            data["labels"] = [data['labels'][i] for i in index]
        else:
            data["ids"] = data['ids'][:length]
            data["premises"] = data['premises'][:length]
