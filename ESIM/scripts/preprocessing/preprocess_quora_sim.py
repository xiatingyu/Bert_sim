...
import sys
sys.path.insert(0, "../../")
from esim.data_sim import Preprocessor
...
def preprocess_PI_data(inputdir,
    ...
    datasets = inputdir + '/train_similarity.tsv'
    valid_datasets = inputdir + '/dev_similarity.tsv'
    test_datasets = inputdir + '/test_similarity.tsv'
    ...
    print("\t* Reading data...")
    data = preprocessor.read_data_sim(datasets)
    ...
    print("\t* Reading data...")
    data = preprocessor.read_data_sim(valid_datasets)
    ...
    print("\t* Reading data...")
    data = preprocessor.read_data_sim(test_datasets)
...
if __name__ == "__main__":
    default_config = "../../config/preprocessing/quora_preprocessing_sim.json"
